...
- [x] 8.3 서버 2개 인스턴스 로컬 구동 후 라운드 로빈 동작 확인 테스트 (curl 스크립트)
- [x] 8.4 1,000명 동시 접속 시뮬레이션 부하 테스트 실행 (k6)
- [x] 8.5 메시지 목록 조회 P99 응답 시간 200ms 이하 달성 확인 (P99=7.04ms)
- [x] 8.6 MongoDB 슬로우 쿼리 임계값 설정: `slowOpThresholdMs: 100` (application.yml)
- [x] 8.7 부하 테스트 결과 리포트 작성 및 `load-test-report.md` 업데이트
